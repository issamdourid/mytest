...
#### réel(S11):
<p align="center">
	<img src="../src/13-07-2021/images/system-real(S11).jpg" alt="Figure 5: Real(S11) : Fitting vs Comsol">
	<br>Figure 5: Real(S11) : Cascade vs Comsol"
</p>
	
#### Imag(S11):
<p align="center">
	<img src="../src/13-07-2021/images/system-imag(S11).jpg" alt="Figure 6: Imag(S11) : Fitting vs Comsol">
