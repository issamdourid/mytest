...
#### réel(S11):
<p align="center">
	<img src="../src/13-07-2021/real-part.jpg" alt="Figure 1: Real(S11) : Fitting vs Comsol">
...
#### réel(S21):
<p align="center">
	<img src="../synthese_implementation/AnalyseMatlab/FP_SAF_HRCS_TREE-2021-07-08/DP/Artix-7FpSafHrcsTreeRapportSyntheseLUT.jpg" alt="Figure 3: Real(S21) : Fitting vs Comsol">
	<br>Figure 3: Real(S21) : Fitting vs Comsol"
</p>
	
#### Imag(S21):
<p align="center">
	<img src="../synthese_implementation/AnalyseMatlab/FP_SAF_HRCS_TREE-2021-07-08/DP/Artix-7FpSafHrcsTreeRapportSyntheseLUT.jpg" alt="Figure 4: Imag(S21) : Fitting vs Comsol">
...
#### réel(S21):
<p align="center">
	<img src="../synthese_implementation/AnalyseMatlab/FP_SAF_HRCS_TREE-2021-07-08/DP/Artix-7FpSafHrcsTreeRapportSyntheseLUT.jpg" alt="Figure 7: Real(S21) : Fitting vs Comsol">
	<br>Figure 7: Real(S21) : Fitting vs Comsol"
</p>
	
#### Imag(S21):
<p align="center">
	<img src="../synthese_implementation/AnalyseMatlab/FP_SAF_HRCS_TREE-2021-07-08/DP/Artix-7FpSafHrcsTreeRapportSyntheseLUT.jpg" alt="Figure 8: Imag(S21) : Fitting vs Comsol">
...
#### réel(S11):
<p align="center">
	<img src="../synthese_implementation/AnalyseMatlab/FP_SAF_HRCS_TREE-2021-07-08/DP/Artix-7FpSafHrcsTreeRapportSyntheseLUT.jpg" alt="Figure 9: Real(S11) : Fitting vs Comsol">
	<br>Figure 9: Real(S11) : Fitting vs Comsol"
</p>
	
#### Imag(S11):
<p align="center">
	<img src="../synthese_implementation/AnalyseMatlab/FP_SAF_HRCS_TREE-2021-07-08/DP/Artix-7FpSafHrcsTreeRapportSyntheseLUT.jpg" alt="Figure 10: Imag(S11) : Fitting vs Comsol">
	<br>Figure 10: Imag(S11) : Fitting vs Comsol"
</p>

#### réel(S21):
<p align="center">
	<img src="../synthese_implementation/AnalyseMatlab/FP_SAF_HRCS_TREE-2021-07-08/DP/Artix-7FpSafHrcsTreeRapportSyntheseLUT.jpg" alt="Figure 11: Real(S21) : Fitting vs Comsol">
	<br>Figure 11: Real(S21) : Fitting vs Comsol"
</p>
	
#### Imag(S21):
<p align="center">
	<img src="../synthese_implementation/AnalyseMatlab/FP_SAF_HRCS_TREE-2021-07-08/DP/Artix-7FpSafHrcsTreeRapportSyntheseLUT.jpg" alt="Figure 12: Imag(S21) : Fitting vs Comsol">
